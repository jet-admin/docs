...
JetAdmin has a built-in **User Management System**. All invited users to your application ([invited by email](../../class-app-builder/core-concept/sharing-your-app/#invite-by-email), [invited by link](../../class-app-builder/core-concept/sharing-your-app/#invite-by-link)), will be available in the **Data** tab in the **"Built-ins"** section.
...
3. **Sharing your app**. Invite your employees or customers to collaborate with your data. See [here](../../class-app-builder/core-concept/sharing-your-app/) for more details.
