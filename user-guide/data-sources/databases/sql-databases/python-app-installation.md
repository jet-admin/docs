...
If you want to run Jet Bridge on a different host or port, read the instructions on the [Configuration page](../../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/configuration.md#setting-up-your-configuration).
