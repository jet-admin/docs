...
Using Database integration you can make simple or [SQL queries](../../../sql-queries-and-api-requests/make-a-sql-query.md) to your database:

{% @arcade/embed flowId="Fg2gqwiVIpsgGl7YNdlq" url="https://app.arcade.software/share/Fg2gqwiVIpsgGl7YNdlq" %}

Here is a [step-by-step guide](../../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/database-heroku-deployment.md) to deploying the database to Heroku and finding your credentials.
