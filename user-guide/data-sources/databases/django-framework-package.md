...
To integrate Jet Admin with your Django project, you need to install the [Jet Bridge](../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/) package. It will work even with your local application on localhost. Jet Bridge is an open-source plugin available on [GitHub](https://github.com/jet-admin/jet-bridge). It will connect to your database and link Jet Admin with your project.&#x20;

{% content-ref url="../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/" %}
[jet-admin](../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/)
{% endcontent-ref %}
...
{% content-ref url="../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/common-problems.md" %}
[common-problems.md](../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/common-problems.md)
{% endcontent-ref %}
