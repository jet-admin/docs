...
Integrate our [Jet Bridge](../../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/) plugin with Docker installation in one command. You can place it behind your VPN, in your own VPC, and works locally. We won’t get access to your data, however, you will still receive updates normally.
