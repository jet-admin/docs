...
| Sync connection   | Source records are copied into Jet Databases | You need synced data, joins across supported sources, or want to migrate from a business app to your own database | Refresh schedule and the connector's write behavior          |
