...
{% content-ref url="../data-sources/storage-and-files/amazon-s3.md" %}
[amazon-s3.md](../data-sources/storage-and-files/amazon-s3.md)
{% endcontent-ref %}

{% content-ref url="../data-sources/storage-and-files/google-cloud-storage.md" %}
[google-cloud-storage.md](../data-sources/storage-and-files/google-cloud-storage.md)
{% endcontent-ref %}

{% content-ref url="../data-sources/databases/firebase-firestore/firebase-cloud-storage.md" %}
[firebase-cloud-storage.md](../data-sources/databases/firebase-firestore/firebase-cloud-storage.md)
{% endcontent-ref %}
