...
{% content-ref url="formulas/" %}
[formulas](formulas/)
{% endcontent-ref %}

{% content-ref url="javascript-column.md" %}
[javascript-column.md](javascript-column.md)
{% endcontent-ref %}

{% content-ref url="calculated-values-in-column.md" %}
[calculated-values-in-column.md](calculated-values-in-column.md)
{% endcontent-ref %}
