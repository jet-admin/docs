...
To pass [values](../../class-app-builder/classic-app-builder/binding-and-values/parameters.md) from SQL Query Builder, such as `id`or `email`, you need to specify them within the Inputs tab:
