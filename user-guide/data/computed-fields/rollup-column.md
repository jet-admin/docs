...
The roll-up allows you to perform a calculation on [Relation](../relationships/link-records-across-tables.md). The most basic computation for the rollup is Count.
