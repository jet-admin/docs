...
Open **Add Function** in the Workflows area to choose **Workflow Builder** (no-code) or **Write Code** (TypeScript). Build the logic first, then attach triggers to turn it into an automation. See [Functions and automations](functions.md).
