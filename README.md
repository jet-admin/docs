...
2. [**Sync and Blend your data**](user-guide/360-data-data-blending.md): Create a single source of truth syncing to your data multiple data sources (Stripe, Hubspot, Salesforce, ...)
3. ****[**Build App Interfaces**:](user-guide/design-and-structure/components/) Drag and drop UI components (Tables, Forms, Charts, Details Images) onto Layouts (Modals, Columns, Tavs) and connect them to data sources
