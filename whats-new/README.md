...
{% hint style="info" %}
July–September entries are **development previews** of Jet Builder v3. Features shown may not yet be available in your project. Dates identify the update snapshots, not general-availability release dates. Screenshots show the interface at the time of each update.
{% endhint %}
