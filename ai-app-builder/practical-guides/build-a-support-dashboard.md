...
For starter ticket records, download the sample CSV. Add a Customer relationship and sample customer records separately for the customer-detail steps.

### Build the list and details

1. Select the source containing the tables.
...
{% @arcade/embed flowId="QdtEXlmnSHv5VUOY4KO4" url="https://app.arcade.software/share/QdtEXlmnSHv5VUOY4KO4" %}
...
{% @arcade/embed flowId="txYVRgIhEenGIqoFe7oA" url="https://app.arcade.software/share/txYVRgIhEenGIqoFe7oA" %}

### Refine and release

Use Edit in Preview for a label change and Theme for appearance. Check mobile navigation and form layout.

{% @arcade/embed flowId="YN8yPPZnPeZHpkMMRnuC" url="https://app.arcade.software/share/YN8yPPZnPeZHpkMMRnuC" %}

Finish with data and access testing and publishing checks. Before publishing, you can share a preview link for feedback.

If a source update fails, capture its inputs and error in Console.
