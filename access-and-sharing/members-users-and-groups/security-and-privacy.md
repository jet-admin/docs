...
JetAdmin has a built-in **User Management System**. All invited users to your application ([invited by email](../../classic-app-builder/design-and-structure/core-concept/sharing-your-app/#invite-by-email), [invited by link](../../classic-app-builder/design-and-structure/core-concept/sharing-your-app/#invite-by-link)), will be available in the **Data** tab in the **"Built-ins"** section.
...
2. **Specify user properties**. Set properties for users to control their [permissions](../app-and-data-permissions/user-and-team-properties.md) and access to data.
3. **Sharing your app**. Invite your employees or customers to collaborate with your data. See [here](../../classic-app-builder/design-and-structure/core-concept/sharing-your-app/) for more details.
...
{% content-ref url="../authentication-and-sso/sign-in-sign-up/" %}
[sign-in-sign-up](../authentication-and-sso/sign-in-sign-up/)
{% endcontent-ref %}
...
{% content-ref url="../app-and-data-permissions/user-and-team-properties.md" %}
[user-and-team-properties.md](../app-and-data-permissions/user-and-team-properties.md)
{% endcontent-ref %}
