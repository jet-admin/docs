...
* Any SSO integrations require you to [connect your custom domain](../../../jet-bridge-deployment/custom-domains/configuring-a-custom-domain.md).
...
{% hint style="info" %}
(optional) If you have self-hosted Jet Bridge set up as [HTTP proxy](../../../jet-bridge-deployment/cloud-jet-bridge-and-on-premises/jet-admin/using-self-deployed-http-proxy.md) access token and refresh token can be saved on self-hosted Jet Bridge side.&#x20;
{% endhint %}
