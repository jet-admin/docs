...
Once you have created the project and selected the Rest API resource, you also selected the [OAuth 2.0](../../user-guide/data-sources/rest-api/oauth-2.0.md) authentication method - you need to select a provider.
