...
{% hint style="info" %}
You can also use data from Jet Tables to [merge it](../synced-tables/) with data from other data sources, write custom SQL on top of it, and access it through [the API](https://docs.jetadmin.io/user-guide/jet-admin-api#resources-api).
{% endhint %}
...
{% hint style="info" %}
To learn about the **common** data section **functionality**, go to the [**data**](/broken/pages/-Mijq8tVt_Z-aalrtffK) page
{% endhint %}
