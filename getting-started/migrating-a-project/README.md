...
{% hint style="info" %}
If you're rebuilding a prototype from another no-code app builder on your real data, start with [Quickstart](../quickstart-2.md) and connect your database directly. There's nothing to export.
{% endhint %}
