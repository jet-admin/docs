...
Before publishing your app, restrict refund and cancellation actions with [visibility rules](../../class-app-builder/classic-app-builder/components-visibility/) or team permissions so only the right people can trigger them.
{% endstep %}
{% endstepper %}
