...
Use an HTML component to include custom HTML and CSS instead of an embedded web page. You can also use a [Custom Component](custom-component/) to include custom React, HTML, and JavaScript.
