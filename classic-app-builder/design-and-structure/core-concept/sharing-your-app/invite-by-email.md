---
description: In this section you will learn how to share your app inviting by Email
---
...
To share your app by email, follow the steps:

1. Click on the `Share` button
2. Write the **email** you want to share the invite with&#x20;
3. Change the **Team**
4. Click on the `Send Invite` button

{% @arcade/embed flowId="PzLj8y6asoiZaZ1TN5P2" url="https://app.arcade.software/share/PzLj8y6asoiZaZ1TN5P2" %}
