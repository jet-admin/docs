...
{% hint style="info" %}
If standard permissions are not enough and you may want to **restrict access** on the level of **individual UI components**, use [user properties](../../access-and-sharing/user-and-team-properties.md) in the visibility logical expression
{% endhint %}
