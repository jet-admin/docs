...
{% content-ref url="../../../user-guide/sql-queries-and-api-requests/make-an-http-request.md" %}
[make-an-http-request.md](../../../user-guide/sql-queries-and-api-requests/make-an-http-request.md)
{% endcontent-ref %}
