...
| **JWT\_VERIFY\_KEY** (optional) | See [Validate JWT Token](../../getting-started/integrations/rest-api/jet-requests-auth.md#validate-jwt-token) | JWT public key to verify user requests                                                        |
