...
| **JWT\_VERIFY\_KEY** (optional) | See [Validate JWT Token](../../user-guide/data-sources/rest-api/jet-requests-auth.md#validate-jwt-token) | JWT public key to verify user requests                                                        |
