...
Once you have created the project, connected the resource, and selected the [Instant Cloud](../user-guide/data-sources/database-resources/instant-cloud.md) deployment method you need to deploy your database on hosting.
...
You need to enter these data in the fields required by the [Instant Cloud](../user-guide/data-sources/database-resources/instant-cloud.md) deployment method.
