...
{% content-ref url="../../../user-guide/data-sources/databases/django-framework-package.md" %}
[django-framework-package.md](../../../user-guide/data-sources/databases/django-framework-package.md)
{% endcontent-ref %}
