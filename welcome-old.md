...
2. [**Sync and Blend your data**](getting-started/synced-tables/): Create a single source of truth (SSOT) that syncs to your multiple data sources (Stripe, Hubspot, Salesforce, ...).
...
5. [**Automate your workflow**](getting-started/workflow/): Create multi-sequence Automation with over 30+ automation blocks and trigger them by Webhook or Schedule jobs every minute, hour, day, or month.
